...
export default function NewCheckSignIcon({sizeClassName, circleClassName, checkClassName}: CheckSignProps) {
  return (
    <svg 
      width="27" 
      height="28" 
