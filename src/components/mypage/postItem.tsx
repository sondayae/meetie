          ...
          <div className="flex-col items-start justify-start gap-6">
            <div className="flex flex-col items-start justify-start gap-3">
              <div className="w-80 items-center justify-start gap-2">
                <div className="font-['Pretendard'] text-base font-semibold text-[#434343]">
                  피그마 고급 스킬 스터디 모집
                </div>
              </div>
              <div className="flex items-start justify-start gap-2">
                <div className="flex items-center justify-center gap-2.5 rounded border border-[#ebe8f5] bg-[#f5f1ff] px-2 py-px">
                  <div className="text-center font-['Pretendard'] text-xs font-normal leading-normal text-[#41364a]">
                    북 스터디
                  </div>
                </div>
                <div className="flex items-center justify-center gap-2.5 rounded border border-[#ebe8f5] bg-[#f5f1ff] px-2 py-px">
            ...
            <div className="flex w-full items-center justify-start gap-1">
              <div className="flex h-6 shrink grow basis-0 items-center justify-start gap-3">
                <div className="font-['Pretendard'] text-xs font-bold text-[#6224fd]">
                  D-9
                </div>
                <div className="flex h-6 shrink grow basis-0 items-center justify-start gap-1">
                  ...
                  <div className="shrink grow basis-0 font-['Pretendard'] text-xs font-medium leading-normal text-[#555555]">
              ...
              <div className="flex h-6 items-center justify-end">
                <div className="flex items-center justify-start gap-0.5">
                  <div className="relative h-3.5 w-3.5" />
                  <div className="w-6 text-right font-['Pretendard'] text-xs font-medium leading-normal text-[#8f8793]">
                    823
                  </div>
                </div>
              </div>
