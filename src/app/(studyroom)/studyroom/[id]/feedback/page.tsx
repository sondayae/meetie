...
export default async function FeedbackListPage({ params }: { params: { id: string } }) {
  ...
  return (
    <>
    <StudyroomHeader />
    <div className='flex-grow h-screen bg-[#FAFAFA] overflow-y-scroll scrollbar-hide px-4'>
      <div className="py-7">
      ...
      <div className="rounded-t-2xl bg-white drop-shadow-[0_-1px_5px_rgba(0,0,0,0.06)]">
          <div className="flex flex-col gap-1 border-b px-7 pt-9 pb-6">
